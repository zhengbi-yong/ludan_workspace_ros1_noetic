...
int main(int argc, char **argv)
{
    ...
    srv.request.pos0 = 1500;
    srv.request.pos1 = 1500;
    srv.request.pos2 = 1500;
    srv.request.pos3 = 1500;
    srv.request.pos4 = 0;
    srv.request.pos5 = 1700;

// 调用服务来设置新位置
    if (client.call(srv)) {
    ROS_INFO("Finger positions changed to new targets.");
} else {
    ROS_ERROR("Failed to call service to change finger positions.");
}
